...
public data class YamlConfiguration constructor(
    ...
    internal val multiLineStringStyle: MultiLineStringStyle = MultiLineStringStyle.DoubleQuoted,
    internal val stringStyle: StringStyle = StringStyle.DoubleQuoted,
)
